...
for i,G in enumerate([G1, G2, G3]):
	...
	draw_network_data(G, ax[0][i], node_size=150)
	ax[0][i].set_title(r"$I = {:.2f}$".format(I) + ", " + pformat(pId, 0.01, 'p_d') + ", " + pformat(pIc, 0.01, 'p_c')
